...
export default {
  ...
  data() {
    return {
      fullText: 'A SOFA, A GOOD BOOK, AND YOU.', // Full text to display
      displayedText: '', // Text that will be displayed with typing effect
      typingIndex: 0, // Index to track typing position
      typingSpeed: 100, // Speed of typing in milliseconds
      searchQuery: '' // Query for the search input
    };
  },
  methods: {
    typeText() {
